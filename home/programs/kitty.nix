...
let
  ...
  toKittyEnv = generators.toKeyValue { mkKeyValue = name: value: "env ${name}=${value}"; };
...
in
{
  options.programs.kitty' = {
    ...
    shellIntegration = {
      ...
      enableFishIntegration = mkEnableOption "Kitty fish integration" // shellIntegrationDefaultOpt;
